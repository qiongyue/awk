...
{\CJKfamily{heiti}{用作正则表达式的字符串}} (\emph{Strings as Regular Expressions}).
...
{\CJKfamily{heiti}{数值或字符串}} (\emph{Number or String}). 表达式的值可以自动从
...
{\CJKfamily{heiti}{运算符总结}} (\emph{Summary of Operators}). 可以出现在表达式中的运算
