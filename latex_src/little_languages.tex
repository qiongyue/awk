...
% Following tikzpicture is generated by awk -f graph.awk graph.data
%
%# graph.awk
%BEGIN {
%    startyear = 1920
...
%        "\\draw (0,0)--(\\width,0)--(\\width,\\height)--(0,\\height)--(0,0);"
%    y1 = (10000 - startdeath) * height / (enddeath - startdeath)
%    y2 = (30000 - startdeath) * height / (enddeath - startdeath)
%    y3 = (50000 - startdeath) * height / (enddeath - startdeath)
%    print "\\draw (0," y1 ") -- (-0.3," y1 ");" \
%          "\\node at (-0.9, " y1 ") {10000};"
%    print "\\draw (0," y2 ") -- (-0.3," y2 ");" \
%          "\\node at (-0.9, " y2 ") {30000};"
%    print "\\draw (0," y3 ") -- (-0.3," y3 ");" \
%          "\\node at (-0.9, " y3 ") {50000};"
%    for (year = 1930; year <= 1980; year += 10) {
%        x = (year - startyear) * width / (endyear - startyear)
%        print "\\draw (" x ",0) -- (" x ",-0.3);"
%        print "\\node at (" x ", -0.6) {" year "};"
%    }
%    print "\\node at (" width / 2 ", -1.3) {Annual Traffic Deaths, " \
%        "USA, 1925-1984};"
%}
%
%{
%    x = ($1 - startyear) * width / (endyear - startyear);
%    y = ($2 - startdeath) * height / (enddeath - startdeath);
%    print "\\fill (" x "," y ") circle (0.4mm);"
%}
%
%END {
...
\begin{tikzpicture}
    ...
    \draw (0,0)--(\width,0)--(\width,\height)--(0,\height)--(0,0);
\draw (0,0.37037) -- (-0.3,0.37037);\node at (-0.9, 0.37037) {10000};
\draw (0,2.22222) -- (-0.3,2.22222);\node at (-0.9, 2.22222) {30000};
\draw (0,4.07407) -- (-0.3,4.07407);\node at (-0.9, 4.07407) {50000};
\draw (1.14286,0) -- (1.14286,-0.3);
\node at (1.14286, -0.6) {1930};
\draw (2.28571,0) -- (2.28571,-0.3);
\node at (2.28571, -0.6) {1940};
\draw (3.42857,0) -- (3.42857,-0.3);
\node at (3.42857, -0.6) {1950};
\draw (4.57143,0) -- (4.57143,-0.3);
\node at (4.57143, -0.6) {1960};
\draw (5.71429,0) -- (5.71429,-0.3);
\node at (5.71429, -0.6) {1970};
\draw (6.85714,0) -- (6.85714,-0.3);
\node at (6.85714, -0.6) {1980};
\node at (4, -1.3) {Annual Traffic Deaths, USA, 1925-1984};
\fill (0.571429,1.36769) circle (0.4mm);
\fill (1.14286,2.3337) circle (0.4mm);
\fill (1.71429,2.63833) circle (0.4mm);
\fill (2.28571,2.49204) circle (0.4mm);
\fill (2.85714,1.92454) circle (0.4mm);
\fill (2.97143,2.39574) circle (0.4mm);
\fill (3.08571,2.33269) circle (0.4mm);
\fill (3.2,2.29398) circle (0.4mm);
\fill (3.31429,2.245) circle (0.4mm);
\fill (3.42857,2.51722) circle (0.4mm);
\fill (3.54286,2.7138) circle (0.4mm);
\fill (3.65714,2.78593) circle (0.4mm);
\fill (3.77143,2.79537) circle (0.4mm);
\fill (3.88571,2.58241) circle (0.4mm);
\fill (4,2.84148) circle (0.4mm);
\fill (4.11429,2.95972) circle (0.4mm);
\fill (4.22857,2.86407) circle (0.4mm);
\fill (4.34286,2.71583) circle (0.4mm);
\fill (4.45714,2.79843) circle (0.4mm);
\fill (4.57143,2.81472) circle (0.4mm);
\fill (4.68571,2.80417) circle (0.4mm);
\fill (4.8,3.0537) circle (0.4mm);
\fill (4.91429,3.30769) circle (0.4mm);
\fill (5.02857,3.67083) circle (0.4mm);
\fill (5.14286,3.80454) circle (0.4mm);
\fill (5.25714,4.15685) circle (0.4mm);
\fill (5.37143,4.14111) circle (0.4mm);
\fill (5.48571,4.32639) circle (0.4mm);
\fill (5.6,4.40213) circle (0.4mm);
\fill (5.71429,4.31731) circle (0.4mm);
\fill (5.82857,4.30944) circle (0.4mm);
\fill (5.94286,4.49898) circle (0.4mm);
\fill (6.05714,4.44926) circle (0.4mm);
\fill (6.17143,3.62926) circle (0.4mm);
\fill (6.28571,3.56713) circle (0.4mm);
\fill (6.4,3.65954) circle (0.4mm);
\fill (6.51429,3.87759) circle (0.4mm);
\fill (6.62857,4.10472) circle (0.4mm);
\fill (6.74286,4.17528) circle (0.4mm);
\fill (6.85714,4.17509) circle (0.4mm);
\fill (6.97143,4.00935) circle (0.4mm);
\fill (7.08571,3.51343) circle (0.4mm);
\fill (7.2,3.38787) circle (0.4mm);
\fill (7.31429,3.54231) circle (0.4mm);
\end{tikzpicture}
\end{center}
