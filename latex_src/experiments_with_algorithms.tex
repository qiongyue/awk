...
\cterm{基本概念}. 用插入排序给一堆卡片排序可以这样做: 每次从卡片堆里
拿出一张, 然后把它插入到手上拿着的卡片的合适位置.
...
% grap -u insertion_sort.grap | pic | troff | grops | ps2eps > insertion_sort.eps
% .G1
% coord x 0,100 y 0,10000
% label left "Comparisons" "+ Exchanges" left 0.4
% label bottom "Number of elements"
% ticks left in 0.08 left 0.04 from 0 to 10000 by 2000
% ticks bot out 0.08 from 0 to 100 by 20
% "INSERTION SORT" at 30,8000
% "reverse-sorted" size -2 at 70,7000
% "random" size -2 at 75,4000
% "equal-element" size -2 at 80,500
% draw solid
% 0 0
% 10 53
% 20 196
...
% .G2
\begin{center}
    \includegraphics{./images/insertion_sort.eps}
\end{center}
...
% grap -u quicksort.grap | pic | troff | grops | ps2eps > quicksort.eps
% .G1
% coord x 0,100 y 0,6000
% label left "Comparisons" "+ Exchanges" left 0.4
% label bottom "Number of elements"
% ticks left in 0.08 left 0.04 from 0 to 6000 by 2000
% ticks bot out 0.08 from 0 to 100 by 20
% "QUICKSORT" at 25,5000
% "reverse-sorted" size -2 at 80,300
% "random" size -2 at 80,1300
% "equal-element" size -2 at 60,3000
% draw solid
% 0 0
% 10 44
% 20 108
...
% .G2
\begin{center}
    \includegraphics{images/quicksort.eps}
\end{center}
...
% grap -u heap_sort.grap | pic | troff | grops | ps2eps > heap_sort.eps
% .G1
% coord x 0,100 y 0,2000
% label left "Comparisons" "+ Exchanges" left 0.4
% label bottom "Number of elements"
% ticks left in 0.08 left 0.04 from 0 to 2000 by 500
% ticks bot out 0.08 from 0 to 100 by 20
% "HEAPSORT" at 20,1500
% "reverse-sorted" size -2 at 70,1300
% "random" size -2 at 80,1500
% "equal-element" size -2 at 80,700
% draw solid
% 0 0
% 10 65
% 20 178
...
% .G2
\begin{center}
    \includegraphics{images/heap_sort.eps}
\end{center}

接下来的这张图显示了本节所讨论的三种排序算法, 在面对随机输入数据时的性能
表现.

% grap -u sort_cmp.grap | pic | troff | grops | ps2eps > sort_cmp.eps
% .G1
% coord x 0,100 y 0,5000
% label left "Comparisons" "+ Exchanges" left 0.4
% label bottom "Number of elements"
% ticks left in 0.08 left 0.04 from 0 to 5000 by 1000
% ticks bot out 0.08 from 0 to 100 by 20
% "COMPARISON OF" "SORTING METHODS" "(RANDOM DATA)" at 30,3800
% "isort" size -2 at 70,3000
% "hsort" size -2 at 80,1500
% "qsort" size -2 at 80,500
% draw solid
% 0 0
% 10 65
% 20 178
...
% .G2
\begin{center}
    \includegraphics{images/sort_cmp.eps}
\end{center}
...
最后一次离开结点 \textit{x} 时把 \texttt{visited[}\textit{x}\texttt{]}
